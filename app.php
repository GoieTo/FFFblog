...
foreach ($article_row as $value) {
    ...
    <tr align="center">
        ...
        <td><input type="button" value="编辑" onclick="window.location.href='<?php echo './edit.php'.'?id='.$value['article_id'] ?>'">
            <input type="button" value="删除" onclick="window.location.href='<?php echo './delete.php'.'?id='.$value['article_id'] ?>'">
        </td>
    </tr>
    <?php
}
